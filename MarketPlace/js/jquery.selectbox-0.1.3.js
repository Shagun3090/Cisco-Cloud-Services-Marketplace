...
//                            var next = parseInt($('input, select').index($(this).prev()), 10) + 1;
//                            console.log(next);
//                            if ($('input, select').eq(next).is('input')) {
//                                console.log(1);
//                                console.log($('input, select').eq(next));
//                                $('input, select').eq(next).focus();
//                            }
//                            else {
//                                console.log(2);
//                                console.log($('input, select').eq(next).next());
//                                $('input, select').eq(next).next().focus();
//                            }
                            /*
